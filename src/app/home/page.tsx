      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 mt-4">
              <Link href="/apadrinar" className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-[#FDD835] text-[#1E3A5F] font-semibold shadow-sm hover:bg-[#FBC02D] transition-colors">
                Apadrinar un niño
              </Link>
              <Link href="/donaciones" className="inline-flex items-center gap-2 px-5 py-3 rounded-full border border-gray-200 text-[#1E3A5F] hover:bg-gray-50 transition-colors">
                Hacer una Donación
              </Link>
            </div>
          </div>
        ...
        <section className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-sm text-center hover:shadow-md transition-shadow">
            ...
            <Link href="/apadrinar" className="mt-4 inline-block text-sm text-[#FDD835] font-semibold hover:text-[#FBC02D]">Apadrinar ahora</Link>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm text-center hover:shadow-md transition-shadow">
            ...
            <Link href="/voluntariado" className="mt-4 inline-block text-sm text-[#FDD835] font-semibold hover:text-[#FBC02D]">Ser voluntario</Link>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm text-center hover:shadow-md transition-shadow">
            ...
            <Link href="/proyectos" className="mt-4 inline-block text-sm text-[#FDD835] font-semibold hover:text-[#FBC02D]">Ver proyectos</Link>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm text-center hover:shadow-md transition-shadow">
            ...
            <Link href="/donaciones" className="mt-4 inline-block text-sm text-[#FDD835] font-semibold hover:text-[#FBC02D]">Donar ahora</Link>
          </div>
        </section>
        ...
        <div className="mt-16 bg-gradient-to-r from-[#FDD835]/10 to-[#FDD835]/30 p-8 rounded-xl text-center">
          ...
          <div className="mt-8 flex justify-center gap-4 flex-wrap">
            <Link href="/apadrinar" className="px-8 py-3 rounded-full bg-[#FDD835] text-[#1E3A5F] font-semibold hover:bg-[#FBC02D] transition-colors">
              Apadrinar un niño
            </Link>
            <Link href="/donaciones" className="px-8 py-3 rounded-full border border-gray-200 text-[#1E3A5F] hover:bg-gray-50 transition-colors">
              Hacer una Donación
            </Link>
          </div>
        </div>
